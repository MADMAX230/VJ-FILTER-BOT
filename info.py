...
API_ID = int(environ.get('API_ID', '16747689'))
API_HASH = environ.get('API_HASH', 'cbced7457e8b79e6b7d8a4e865cec8e2')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '705677320 5240266552 7269071027').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002958036467').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002194126237') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://albysilvymildamilan469_db_user:WhEAPbex5aXvB4lN@cluster0.rfpls7q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
REFERAL_PREMEIUM_TIME = environ.get('REFERAL_PREMEIUM_TIME', '') # time in week, day, month.
